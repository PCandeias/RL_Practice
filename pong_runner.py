...
agent = CNNDQNAgent(env.observation_space.shape, env.action_space.n, priority_replay=True, min_history_size=10000, train_frequency=4, gamma=0.99, alpha=0.0001, freeze_target_frequency=1000)
